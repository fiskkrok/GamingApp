    ...
    private static async Task InitializeDataAsync(AppDbContext dbContext)
    {
        ...
        await strategy.ExecuteAsync(async () =>
        {
            ...
            try
            {
                ...
                var user = await SeedDataFactory.CreateSeedData(typeof(User)) as User;

                var newGameSessions = await SeedDataFactory.CreateSeedData(typeof(GameSession)) as List<GameSession>;
